...
}),e.on("keyup",function(b){(38===b.keyCode||40===b.keyCode)&&(a(this).find(f).addClass(d.openedClass),a(this).find(h).show());var e=a(this).find("li"),g=a(this).find("."+d.selectedClass),i="",j="";40===b.keyCode&&(g.removeClass(d.selectedClass),i=g.next(),i.length>0?i.addClass(d.selectedClass):e.first().addClass(d.selectedClass)),38===b.keyCode&&(g.removeClass(d.selectedClass),j=g.prev(),j.length>0?j.addClass(d.selectedClass):e.last().addClass(d.selectedClass)),13===b.keyCode&&c(a(this).find("."+d.selectedClass))}),e.on("blur",function(){a(this).find(h).is(":visible")&&(a(this).find(f).removeClass(d.openedClass),a(this).find(h).hide())}),a("html").on("keyup",function(a){27===a.keyCode&&(f.removeClass(d.openedClass),h.hide())}),a("html").on("mousedown",function(b){var c=a(b.target);c.parents().addBack().is("."+d.menuClass+" ul, ."+d.menuClass+" label")||(a("."+d.menuClass+" label").removeClass(d.openedClass),a("."+d.menuClass+" ul").hide())})})}}(jQuery),jQuery(document).ready(function(a){function b(){function b(){var b=d();c.reloadSlider(a.extend(b,{startSlide:c.getCurrentSlide()}))}var c,d=function(){var b,c={maxSlides:1},d={maxSlides:2},e={maxSlides:3},f={maxSlides:4},g={maxSlides:5},h={minSlides:1,moveSlides:1,slideWidth:170,slideMargin:18,pager:!1,controls:!1,auto:!0,pause:6e3};return 400>=q&&(b=a.extend(c,h)),q>400&&500>=q&&(b=a.extend(d,h)),q>500&&760>=q&&(b=a.extend(e,h)),q>760&&1e3>=q&&(b=a.extend(f,h)),q>1e3&&(b=a.extend(g,h)),b},e=d();c=a(".js-slider-partners").bxSlider(e),n.on("resize",function(){setTimeout(b,500)})}function c(){a(".js-p-slider").find(".captions-list__link:first").addClass("active");var b=a(".p-slider__arrow--left"),c=a(".p-slider__arrow--right"),d=a(".captions-list li"),e=d.find("a"),f=a(".p-slider__list").bxSlider({auto:!1,mode:"fade",pager:!1,nextSelector:c,prevSelector:b,nextText:"",prevText:"",onSlideBefore:function(a,b,c){e.removeClass("active"),d.eq(c).find("a").addClass("active")}});a(".js-p-slider").on("click",".captions-list__link",function(b){b.preventDefault();var c=a(this);if(c.hasClass("active"))return!1;var d=c.parent("li").index();f.goToSlide(d)})}function d(){var b=a(".q-slider__arrow--left"),c=a(".q-slider__arrow--right");a(".q-slider__list").bxSlider({auto:!1,pager:!1,nextSelector:c,prevSelector:b,nextText:"",prevText:""})}function e(){n.unbind("scroll",f),a(".graph__line").addClass("active"),setTimeout(function(){a(".graph__part--1").fadeIn(1200,function(){a(".graph__num--1").addClass("active"),a(".graph__part--2").fadeIn(1200,function(){a(".graph__num--2").addClass("active"),a(".graph__part--3").fadeIn(1200,function(){a(".graph__num--3").addClass("active"),a(".graph__part--4").fadeIn(1200,function(){a(".graph__num--4").addClass("active"),a(".graph__part--5").fadeIn(1e3,function(){a(".graph__num--5").addClass("active"),a(".graph__part--6").fadeIn(800,function(){a(".graph__num--6").addClass("active")})})})})})})},3e3)}function f(){verge.inY(a(".graph"))&&e()}function g(){a(".animate").each(function(){var b=a(this);if(verge.inY(b)){var c=b.data("animate");b.removeClass("animate").addClass("animated "+c),a(".animate").length||n.unbind("scroll",g)}})}function h(){a(".p-counter").each(function(){var b=a(this);verge.inY(b)&&b.not(".started")&&b.addClass("started").find(".p-counter__num").each(function(){a(this).prop("Counter",0).animate({Counter:a(this).text()},{duration:4e3,easing:"swing",step:function(b){a(this).text(Math.ceil(b))}})}),a(".p-counter").not(".started").length||n.unbind("scroll",h)})}function i(){function b(){return e=f.position().top+f.outerHeight(!0)}function c(){var a=f.find("li").length;h>a&&(b(),n.bind("scroll",d))}function d(){var b=e-verge.scrollY()-verge.viewportH();if(0>=b){n.unbind("scroll",d),g.fadeIn(),f.after('<ul class="g-hidden" id="hidden"></ul>');var h=a("#hidden");h.load("ajax/_news_content.html li",function(){h.find("li").each(function(){var b=a(this);f.append(b)}),f.find("img[data-src]").unveil(),h.remove(),g.fadeOut(),c()})}}var e,f=a(".js-news"),g=a(".loader"),h=f.data("total");c(),n.on("resize",function(){setTimeout(b,200)})}function j(){function b(a,b){e=!0,d.fadeIn(),b.load("ajax/_portfolio_content.html ul",function(){b.addClass("loaded").removeClass("g-hidden"),a.addClass("active"),c(b),m(b,18),d.hide(),e=!1})}function c(b){var c=b.find(".js-folio").masonry({itemSelector:".folio-grid__item"});b.find("img[data-src]").unveil(),a("[data-qtip]").qtip("destroy",!0),a("[data-qtip-alt]").qtip("destroy",!0),initTooltips(),b.on("click",".folio-grid__wrap",function(b){b.preventDefault();var d=a(this),e=d.next(".folio-grid__link");d.hasClass("active")?(d.removeClass("active"),e.removeClass("active")):(d.addClass("active"),e.addClass("active")),c.masonry("layout")})}var d=a(".loader"),e=!1;a(".js-folio-list").find(".p-slider__link").each(function(){if(a(this).hasClass("active")){var b=a(this).next(".g-container");m(b,18)}}),a(".js-folio-list").on("click",".p-slider__link",function(c){if(c.preventDefault(),e)return!1;var d=a(this),f=d.next(".g-container");d.hasClass("active")?(d.removeClass("active"),f.fadeOut()):f.hasClass("loaded")?(d.addClass("active"),f.fadeIn()):b(d,f)})}function k(){var b=a(".p-tabs__content"),c=a(".js-tabs"),d="p-tabs__link--current";b.not(":first").hide(),c.each(function(){var b=a(this).find("."+d);b.length<1&&a(this).find(".p-tabs__link").filter(":first").addClass(d),b=a(this).find("."+d).attr("href"),a(b).show()}),c.on("click",".p-tabs__link",function(b){b.preventDefault();var c=a(this),e=c.parents(".js-tabs"),f=c.attr("href"),g=e.find("."+d).attr("href");return c.hasClass(d)?!1:(console.log(f,g),a(g).hide(),e.find(".p-tabs__link").removeClass(d),c.addClass(d),a(f).fadeIn(),history.pushState(null,null,window.location.search+c.attr("href")),void 0)});var e=window.location.hash;if(""!=e)try{var f=c.find("a[href^="+e+"]").parents(".js-tabs").find(".p-tabs__link"),g=f.filter("."+d).attr("href");a(g).hide(),f.removeClass(d),c.find("a[href^="+e+"]").addClass(d);var h=a("#"+e.replace("#",""));h.show(),m(h,18)}catch(i){}}function l(){function b(){q>=p&&(c.show(),a(".js-toggle-filter").addClass("active"))}var c=a(".c-filter");a(".c-sidebar").on("click",".js-toggle-filter",function(){a(this).toggleClass("active"),c.slideToggle()}),n.on("resize",function(){setTimeout(b,800)})}function m(b,c){c||(c=0);var d=35+c;q>=p&&(d=90+c),a("html, body").animate({scrollTop:b.offset().top-d},800)}var n=a(window),o=a("body"),p=768,q=0,r=function(){return q=verge.viewportW()}();n.on("resize",function(){setTimeout(r,300)}),a("img[data-src]").unveil();(function(){function b(){q=n.width(),q>750&&c.isOpen()&&c.close()}if(!a("html").hasClass("lt-ie9")){var c=new Slideout({panel:document.getElementById("page"),menu:document.getElementById("slide"),padding:256,tolerance:70,side:"right"});a(".controls").on("click",".menu__btn",function(){c.toggle()}),a("#slide").on("click",".m-menu__title",function(){c.close()}),a(window).on("resize",function(){setTimeout(b,500)}),a(".js-menu").on("click",".m-menu__link--has-menu",function(b){b.preventDefault(),a(this).hasClass("active")?a(this).removeClass("active").next("ul").slideUp("fast"):a(this).addClass("active").next("ul").slideDown("fast")})}})(),function(){var b=a(".menu"),c=b.find("a");c.hover(function(){a(this).hasClass("menu__link--current")||b.addClass("hover")},function(){b.removeClass("hover")})}(),function(){function b(){j.css("height",f),e.addClass("fixed")}function c(){j.removeAttr("style","height"),e.removeClass("fixed")}var d=a("#content"),e=a(".header"),f=90,g=!1,h=!1,i=0;if(e.hasClass("header--hero")){g=!0,a(".d-menu").wrap('<div class="d-menu__wrap"></div>');var j=a(".d-menu__wrap"),i=d.offset().top-n.scrollTop();f>i&&(e.addClass("scrolled"),h=!0,b())}a(window).on("scroll",function(){i=d.offset().top-n.scrollTop(),i>=f&&h&&(e.removeClass("scrolled"),h=!1,g&&c()),f>i&&!h&&(e.addClass("scrolled"),h=!0,g&&b())})}();a(".js-slider-partners").length&&b(),a(".js-p-slider").length&&c(),a(".js-q-slider").length&&d(),a(".seo").one("click",".js-seo",function(b){b.preventDefault();var c=a(this).attr("href");a(c).removeClass("g-hidden"),a(this).fadeOut()}),a(".graph").length&&n.bind("scroll",f),a(".animate").length&&n.bind("scroll",g),a(".p-counter__item").length&&n.bind("scroll",h),initTooltips=function(){var b={position:{target:"mouse",container:a("#page"),adjust:{x:15,y:15,resize:!0}},show:{delay:600},hide:{event:"click mouseleave"}},c={position:{target:"mouse",container:a("#page"),adjust:{x:15,y:15,resize:!0}},show:{delay:600},hide:{event:"click mouseleave"}},d={content:{attr:"data-qtip"}},e={content:{attr:"data-qtip-alt"}},f={style:{classes:"qtip-alt"}};a("[data-qtip]").qtip(a.extend(b,d)),a("[data-qtip-alt]").qtip(a.extend(c,e,f))},initTooltips(),a(".js-news").length&&i(),a(".js-folio-list").length&&j(),a(".js-folio-post").length&&m(a(".js-folio-post"),54),a(".js-popup").lightbox({margin:20,blur:!1}),a(".js-tabs").length&&k(),a(".js-toggle-filter").length&&l(),a(".c-filter__select").length&&a(".c-filter__select").customSelectMenu();(function(){var b=a(".js-notice");b.append('<a class="g-notice__close"><i class="icon-cancel"></i></a>'),b.on("click",".g-notice__close",function(b){b.preventDefault(),a(this).parent("div").fadeOut()})})(),function(){var b=a('<div class="scroll-up-btn"><i class="icon-up-open-big"></i></div>');o.append(b),n.on("scroll",function(){verge.scrollY()>300?b.show():b.hide()}),b.on("click",function(){return a("html, body").animate({scrollTop:0},800),!1})}();Modernizr.svg||a('img[src*="svg"]').attr("src",function(){return a(this).attr("src").replace(".svg",".png")})});